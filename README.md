...
**MPM 最初只是我在自己开发项目过程中随手搭建的一个 MCP 工具集**

名字也是随便起的（MyProjectManager）。它一开始只是个玩具，后来它就越来越不像玩具了，就这么回事。
...
**[Windows 版下载](https://github.com/halflifezyf2680/MyProjectManager/releases/download/v1.0.0/MyProjectManager-v1.0.0.zip)** 
